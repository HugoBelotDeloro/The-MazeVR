...
public class UIController : MonoBehaviour
{
    ...
    private readonly Color _colorActive = new Color(96, 0, 165, 255);
    private readonly Color _colorInactive = new Color(64, 0, 110, 255);
    ...
    private void Update()
    {
        ...
        else if (_selected == 1 && Math.Abs(Input.GetAxis("Side")) > 0.1)
        {
            ...
            mixer.SetFloat("MixerVolume", Mathf.Log10(volume.value) * 20);
        }
